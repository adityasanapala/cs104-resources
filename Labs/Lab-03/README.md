...
(vi) Footer Tag at the end will display your name. (vii) Also, give a title to the website.
...
(iii) Include a navigation bar on the webpage. Change the background color of the navigation bar. (iv) Also, add a footer in your document. The text color of the footer should be white.
...
In 2024, CSE Trip happened to Daman and Silvassa. CSE Council wants to conduct an anonymous feedback. Surprisingly, they dont know how to make a Google Form! Help them make a survey form in HTML, CSS, and JavaScript.
