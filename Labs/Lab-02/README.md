...
(vil) You need to write your unix command (maybe, sequence of commands) in commands.sh.

(vili) Print the valid lines in 'valid.txt'
...
sakshamrathi21 1 22b1003@jitb.ac.in submission.sh
...
For example, if your command for part (1) is find _____, then write find _____ > 1.txt
